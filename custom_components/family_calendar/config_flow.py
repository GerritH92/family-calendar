    ...
    async def async_step_init(self, user_input=None):
        ...
        if user_input is not None:
            ...
            if user_input.get("name"):
                new_data["name"] = user_input.get("name")
            ...
            if calendar_entity and DOMAIN in self.hass.data:
                ...
                if user_input.get("name"):
                    self.hass.data[DOMAIN]["names"][calendar_entity] = user_input.get("name")
                
                if user_input.get("weather_entity"):
                    self.hass.data[DOMAIN]["weather_entity"] = user_input.get("weather_entity")
